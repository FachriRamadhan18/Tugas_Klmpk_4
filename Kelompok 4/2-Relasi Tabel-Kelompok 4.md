...
| No  | Nama             | Peran                      | Nilai |
| --- | ---------------- | -------------------------- | ----- |
| 1   | Fachri Ramadan   | Ketik Query                | 3     |
| 2   | M.Nafan Nabil N  | Mencari Materi             | 3     |
| 3   | Raihan Alfazhari | Mengupload Materi          | 3     |
| 4   | Muhammad Fadhil  | Menggabungkan semua materi | 3     |
**Keterangan :**
0 : Tidak Aktif
1 : Kurang Aktif
2 : Cukup Aktif
...
![gambar](Aset/pratikum1.png)

# Tabel Employees

![gambar](Aset/pratikum2.png)

# Tabel Products

![gambar](Aset/pratikum6.png)

# Tabel Orders

![gambar](Aset/pratikum3.png)

# Tabel OrderDetails

![gambar](Aset/pratikum4.png)
...
SELECT c.CustomerID, c.CompanyName, o.OrderID,
    ...
    WHERE c.CustomerID =o.CustID AND o.OrderID = od.OrdersID
...
SELECT c.CustomerID, c.CompanyName, o.OrderID as OrdID, o.OrderDate, CONCAT(e.LastName, ', ', e.FirstName) AS EmployeeName, od.ProductID as ProdID,
    ...
    WHERE c.CustomerID=o.CustID AND o.OrderID=od.OrdersID AND p.ProductID=od.ProductID AND e.EmpID=o.EmpID ORDER BY o.OrderID;
```
...
CREATE VIEW odproducts
    AS
    SELECT od.OrdersID, od.ProductID, p.ProductName,
